...
start_service api-gateway env PAYER_CORE_URL="http://localhost:8081" PROVIDER_SERVICE_URL="http://localhost:8082" GOCACHE="$ROOT_DIR/.gocache" go run ./apps/api-gateway
