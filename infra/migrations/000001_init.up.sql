...
INSERT INTO providers (id, name, provider_type, tier_rank, region) VALUES
  ...
  ('provider-crown-dental', 'Crown Dental Clearinghouse', 'Clinic', 'Gold', 'Rimaros'),
...
INSERT INTO trading_partners (id, name, sender_id, receiver_id, allowed_transaction_types, validation_profile, route_target, status) VALUES
  ...
  ('tp-vitesse-temple', 'Temple of the Healer, Vitesse', 'provider-vitesse-temple', 'Adventure Society', '270,269,275,276,278,837,837D', '{"attachmentTypes":["OZ"],"reportTypeCodes":["B4"],"transmissionCodes":["EL"],"contentTypes":["text/plain","application/pdf","image/jpeg"],"allowedFileExtensions":[".txt",".pdf",".jpg",".jpeg"],"controlNumberPrefixes":["TEMPLE-","ATTACH-","XML-"],"maxEmbeddedContentBytes":4096,"maxAttachmentsPerPacket":5,"unsolicitedAttachmentWindowDays":0,"serviceTypes":["resurrection","restoration","curse-removal","trauma-care","dental-predetermination"],"incidentSeverities":["Normal","Awakened","Diamond"],"diagnosisQualifiers":["ABK","ABF"],"diagnosisCodes":["S610","T509","S062X9A","K021"],"procedureCodePrefixes":["ASHN","D"],"dentalCdtRanges":["D7000-D7999"],"dentalRequiredAttachmentCodes":["XRAY","PERIO","NARR","PLAN"],"dentalRequiresToothNumber":true,"dentalAllowedSurfaces":["O","M","D","B","L","MO","DO","MOD"],"dentalAllowedQuadrants":["UR","UL","LR","LL"],"dentalPredeterminationRules":["oral-surgery-only","accepted-275-evidence-required","same-day-unsolicited-attachments"]}'::jsonb, 'payer-core', 'active'),
  ('tp-rimaros-hospital', 'Rimaros City Hospital', 'provider-rimaros-hospital', 'Adventure Society', '270,269,275,276,278,837,837D', '{"attachmentTypes":["OZ","PN"],"reportTypeCodes":["03","B4"],"transmissionCodes":["EL"],"contentTypes":["text/plain","application/pdf"],"allowedFileExtensions":[".txt",".pdf"],"controlNumberPrefixes":["RIM-","ATTACH-","XML-"],"maxEmbeddedContentBytes":8192,"maxAttachmentsPerPacket":5,"unsolicitedAttachmentWindowDays":7,"serviceTypes":["resurrection","restoration","curse-removal","trauma-care","dental-predetermination"],"incidentSeverities":["Normal","Awakened","Diamond"],"diagnosisQualifiers":["ABK","ABF"],"diagnosisCodes":["S610","T509","S062X9A","M542","K021"],"procedureCodePrefixes":["ASHN","RIM","D"],"dentalCdtRanges":["D0000-D9999"],"dentalRequiredAttachmentCodes":["XRAY","NARR"],"dentalRequiresToothNumber":false,"dentalAllowedSurfaces":["O","M","D","B","L","MO","DO","MOD"],"dentalAllowedQuadrants":["UR","UL","LR","LL"],"dentalPredeterminationRules":["broad-dental-review","seven-day-unsolicited-window"]}'::jsonb, 'payer-core', 'active'),
  ('tp-crown-dental', 'Crown Dental Clearinghouse', 'provider-crown-dental', 'Adventure Society', '270,269,275,278,837D', '{"attachmentTypes":["OZ"],"reportTypeCodes":["B4","XR"],"transmissionCodes":["EL"],"contentTypes":["application/pdf","image/jpeg"],"allowedFileExtensions":[".pdf",".jpg",".jpeg"],"controlNumberPrefixes":["CROWN-","DENT-"],"maxEmbeddedContentBytes":6144,"maxAttachmentsPerPacket":4,"unsolicitedAttachmentWindowDays":3,"serviceTypes":["dental-predetermination"],"incidentSeverities":["Normal","Awakened"],"diagnosisQualifiers":["ABK"],"diagnosisCodes":["K021","K029"],"procedureCodePrefixes":["D"],"dentalCdtRanges":["D1000-D4999"],"dentalRequiredAttachmentCodes":["XRAY","NARR"],"dentalRequiresToothNumber":true,"dentalAllowedSurfaces":["O","M","D","B","L"],"dentalAllowedQuadrants":["UR","UL","LR","LL"],"dentalPredeterminationRules":["preventive-basic-only","three-day-unsolicited-window","pdf-or-image-evidence"]}'::jsonb, 'payer-core', 'active'),
  ('tp-adventure-society-remittance', 'Adventure Society Remittance', 'Adventure Society', 'provider-vitesse-temple', '835', '{}'::jsonb, 'payer-core', 'active')
