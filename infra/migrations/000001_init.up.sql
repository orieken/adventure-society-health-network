...
INSERT INTO trading_partners (id, name, sender_id, receiver_id, allowed_transaction_types, validation_profile, route_target, status) VALUES
  ...
  ('tp-vitesse-temple', 'Temple of the Healer, Vitesse', 'provider-vitesse-temple', 'Adventure Society', '270,275,276,278,837', '{"attachmentTypes":["OZ"],"reportTypeCodes":["B4"],"transmissionCodes":["EL"],"contentTypes":["text/plain"],"controlNumberPrefixes":["TEMPLE-","ATTACH-","XML-"],"maxEmbeddedContentBytes":4096,"serviceTypes":["resurrection","restoration","curse-removal","trauma-care","dental-predetermination"],"incidentSeverities":["Normal","Awakened","Diamond"],"diagnosisQualifiers":["ABK","ABF"],"diagnosisCodes":["S610","T509","S062X9A"],"procedureCodePrefixes":["ASHN"]}'::jsonb, 'payer-core', 'active'),
  ('tp-rimaros-hospital', 'Rimaros City Hospital', 'provider-rimaros-hospital', 'Adventure Society', '270,275,276,278,837', '{"attachmentTypes":["OZ","PN"],"reportTypeCodes":["03","B4"],"transmissionCodes":["EL"],"contentTypes":["text/plain","application/pdf"],"controlNumberPrefixes":["RIM-","ATTACH-","XML-"],"maxEmbeddedContentBytes":8192,"serviceTypes":["resurrection","restoration","curse-removal","trauma-care","dental-predetermination"],"incidentSeverities":["Normal","Awakened","Diamond"],"diagnosisQualifiers":["ABK","ABF"],"diagnosisCodes":["S610","T509","S062X9A","M542"],"procedureCodePrefixes":["ASHN","RIM"]}'::jsonb, 'payer-core', 'active'),
