...
- [ ] Add `attachmentPurpose` to 275 payloads: `unsolicited` and `solicited`.
- [ ] Generate `BGN` for raw 275 output and parse `BGN01/BGN02` from inbound raw 275.
- [ ] Store payer request trace for solicited claim documentation requests and require response trace matching.
...
- [ ] Add duplicate attachment-control-number detection by claim/request context.
